...
try {
    ...
    $grn_number = "GRN-" . $year . "-" . str_pad($count, 3, '0', STR_PAD_LEFT);
    
    echo json_encode(['success' => true, 'grn_number' => $grn_number]);
} catch (PDOException $e) {
    error_log("Error in get_next_grn_number: " . $e->getMessage());
